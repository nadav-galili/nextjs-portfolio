    ...
    <header
      ...
      <div className="w-full flex justify-between items-center lg:hidden ">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://twitter.com/nadavgalili"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3">
          ...
          <motion.a
            href="https://github.com/nadav-galili"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3">
          ...
          <motion.a
            href="https://www.linkedin.com/in/nadav-galili"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 ml-3">
        ...
        <motion.div
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mx-3 bg-light rounded-fill dark:bg-dark sm:mx-1">
              <GithubIcon />
            </motion.a>
            <motion.a
